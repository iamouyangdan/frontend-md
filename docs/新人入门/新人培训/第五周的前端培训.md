...
[uni-app官网](https://uniapp.dcloud.io/collocation/manifest.html)

pages.json 

[uni-app页面路由](https://uniapp.dcloud.io/collocation/pages.html)
...
[uni-app官网](https://uniapp.dcloud.io/tutorial/platform.html)

## 组件

和vue的写法一致，需要注意组件文件存放规则，公共组件放在components文件夹下，私有组件放在页面文件夹下的components文件下

[uni-app官网](https://uniapp.dcloud.io/tutorial/vue-components.html)
